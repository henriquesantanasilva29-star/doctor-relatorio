...
var REGUAS = {
  'caixa.hub.semdoc': { rot: 'caixa · sem convênio',
    ...
    naoBate: ['proposta.face', 'funil.movimento'] },
  ...
  'funil.movimento': { rot: 'movimento de cartão',
    txt: 'Cartões que passaram pela etapa no dia. Não é saldo: um cartão que avançou três etapas aparece nas três.',
